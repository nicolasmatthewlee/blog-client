    ...
    <div className="hidden lg:block w-72 border-l-2 p-4 pt-8 space-y-6 overflow-scroll">
      ...
      <div className="border-b-2 pb-4">
        <div className="flex space-x-1 items-center">
          ...
          <h3 className="font-medium text-gray-700 text-sm">Popular authors</h3>
        </div>
        <div className="mt-4 space-y-4">
          <TrendingUser />
          <TrendingUser />
      ...
      <div className="pb-4">
        <div className="flex space-x-1 items-center">
          ...
          <h3 className="font-medium text-gray-700 text-sm">Topics for you</h3>
        </div>
        <div className="mt-4 space-x-1 space-y-1">
          <RecommendedTopic name="Technology" />
          <RecommendedTopic name="Design" />
          <RecommendedTopic name="Crypto" />
          <RecommendedTopic name="Personal Growth" />
          <RecommendedTopic name="Politics" />
        </div>
      </div>
    </div>
  );
